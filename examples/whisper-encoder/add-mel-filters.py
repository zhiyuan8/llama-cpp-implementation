...
if __name__ == "__main__":
    bin_file = "models/ggml-medium.bin"
    gguf_file = "models/nano-omni-instruct.audio_tower-multi_modal_projector.gguf"
    output_file = "models/nano-omni-instruct.mel-filters-audio_tower-multi_modal_projector.gguf"
