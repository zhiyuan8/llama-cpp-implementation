...
class NexaOmniAudioInference:
    ...
    def __init__(
        ...
        self.ctx_params = qwen2_audio_cpp.omni_context_default_params()
        self.context = None
        self._load_model()
    ...
    def _load_model(self):
        ...
        try:
            ...
            self.context = qwen2_audio_cpp.omni_init_context(
    ...
    def run(self):
        while True:
            try:
                ...
                qwen2_audio_cpp.omni_process_full(
    ...
    def __del__(self):
        ...
        """
        if self.context:
            qwen2_audio_cpp.omni_free(self.context)
