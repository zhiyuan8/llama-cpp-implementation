...
int main(int argc, char **argv)
{
    ...
    // Step 1 : Parse command line parameters into the params structure
    ...
    // step 2 : whisper hyperaparameters and tensor data read in
    ...
    for (int f = 0; f < (int)params.fname_inp.size(); ++f)
    {
        ...
        // step 3 : run the inference
        {
            ...
            // step 4 : run the inference, whisper encoder without cross-attention
