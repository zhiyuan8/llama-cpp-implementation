...
if __name__ == "__main__":
    bin_file = "ggml-medium.bin"
    gguf_file = "nano-omni-instruct.audio_tower-multi_modal_projector.gguf"
    output_file = "nano-omni-instruct.mel-filters-audio_tower-multi_modal_projector.gguf"
